...
# Define the resources and other variables
resources = {
    "receptionist": ["robot_receptionist1", "robot_receptionist2"],
    "tables": ['1', '2', '3', '4', '5', '6'],
    "waiter": ['robot_waiter1', 'robot_waiter2'],
    "chef": ['chef1', 'chef2']
}
...
activities = ["Greeted By Robot", "Seated By Robot", "Ordered taken by Robot", "Prepared", "Served By Robot", "Paid to Robot"]
...
df.to_csv('robot_restaurant_data.csv', index=False)
